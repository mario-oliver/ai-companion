...
export async function POST(
    ...
    try {
        ...
        //check for this specific user and rate limit only him (not all users)
        ...
        //https://replicate.com/a16z-infra/llama-2-13b-chat/api for model
